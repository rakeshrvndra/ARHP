...
-(NSString *)getNextShowTimeWithTime:(NSString *)nextTime{
    ...
    }else if (nextTime.length == 4){
        
        int hour = 12;
        [nextTimeMutated insertString:@":" atIndex:2];
        time = [NSString stringWithFormat:@"%@ %i:%@AM", @"AT" , hour, [nextTimeMutated substringFromIndex:0]];
        
    }else if (nextTime.length == 3){
        
        int hour = 12;
        [nextTimeMutated insertString:@":" atIndex:1];
        time = [NSString stringWithFormat:@"%@ %i:0%@AM", @"AT" , hour, [nextTimeMutated substringFromIndex:0]];
