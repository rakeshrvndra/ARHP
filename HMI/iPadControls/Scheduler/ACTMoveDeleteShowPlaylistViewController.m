...
-(void)deleteShow{
    ...
    }else if (_buttonTag < 800){
        
        [_schedule insertObject:[NSNumber numberWithInt:0] atIndex:798];
        [_schedule insertObject:[NSNumber numberWithInt:0] atIndex:798];
        
    }else if (_buttonTag < 1200){
        
        [_schedule insertObject:[NSNumber numberWithInt:0] atIndex:1198];
        [_schedule insertObject:[NSNumber numberWithInt:0] atIndex:1198];
        
    }else if (_buttonTag < 1600){
        
        [_schedule insertObject:[NSNumber numberWithInt:0] atIndex:1598];
        [_schedule insertObject:[NSNumber numberWithInt:0] atIndex:1598];
        
    }else if (_buttonTag < 2000){
        
        [_schedule insertObject:[NSNumber numberWithInt:0] atIndex:1998];
        [_schedule insertObject:[NSNumber numberWithInt:0] atIndex:1998];
        
    }else if (_buttonTag < 2400){
        
        [_schedule insertObject:[NSNumber numberWithInt:0] atIndex:2398];
        [_schedule insertObject:[NSNumber numberWithInt:0] atIndex:2398];
        
    }else{
        
        [_schedule insertObject:[NSNumber numberWithInt:0] atIndex:2798];
        [_schedule insertObject:[NSNumber numberWithInt:0] atIndex:2798];
...
-(void)changeTime{
    ...
    int lastDaysShowNum = [_schedule[(_dayOfTheWeek == 0 ? 697 : 400 * (_dayOfTheWeek - 1) + 399)] intValue];
    ...
    if ( (_dayOfTheWeek == 1) && ([_schedule[0] intValue] == 0)){
        ...
        for (int i = 400 * (_dayOfTheWeek == 0 ? 6 : _dayOfTheWeek - 1) + 1; i < 400 * ((_dayOfTheWeek == 0 ? 6 : _dayOfTheWeek - 1)) + (_dayOfTheWeek == 0 ? 398 : 398); i+=2){
    ...
    for (int i = 400 * _dayOfTheWeek; i < (_dayOfTheWeek == 6 ? 2796: 400 * _dayOfTheWeek + 398); i+=2){
        ...
        int firstNextDaysStarting = [_schedule[_dayOfTheWeek == 6 ? 0 : (400 * (_dayOfTheWeek + 1)) - 2 ] intValue];
        ...
        }else if ((((_selectedTime <= _lowestTime) || (_selectedTime >= _lowestTime))   && (i == (400 * _dayOfTheWeek)) && (myEndingTime <= previousStaringTime))){
