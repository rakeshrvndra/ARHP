...
-(void)setSelected:(BOOL)selected{
    ...
    if(selected){
        ...
        self.detailTextLabel.textColor = [UIColor colorWithRed:200.0/255.0f green:200.0/255.0f blue:200.0/255.0f alpha:1.0f];
        self.textLabel.textColor = [UIColor colorWithRed:200.0/255.0f green:200.0/255.0f blue:200.0/255.0f alpha:1.0f];
